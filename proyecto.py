...
print("Hola, bienvenidos a la tienda de videojuegos Moral De Perro Games")
print("Elija una de las siguientes opciones: ")
print("1) Ver la lista de los juegos de la tienda") 
print("2) Buscar videojuegos") 
print("3) Agregar videojuegos al carrito de compras") 
print("4) Ver videojuegos agregados al carrito de compras")
print("5) Eliminar juegos del carrito de compras")
